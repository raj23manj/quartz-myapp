...
//        params.add(criteriaBuilder.equal(planRoot.get("autoGenerateInstallments"), autoGenerateInstallments));
//        return this;
//    }
//
//    public PlanFinder withEntityVersion(String entityVersion) {
//        if (entityVersion != null)
//            params.add(criteriaBuilder.equal(planRoot.get("entityVersion"), entityVersion));
//        return this;
//    }
//
...
//    }
//
//    // todo load related entities only on cue
